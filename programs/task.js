...
//     const ans = spiData.filter(temp=>temp.spi>=5.1);
//     res.send(ans)
// })
...
// app.get("/index",(req,res)=>{
//     const ans = spiData.filter(temp=>temp.language=="Hindi");
//     res.send(ans)
// })

app.get("/index",(req,res)=>{
    const ans = spiData.filter(temp=>temp.language=="Sindhi" && temp.name.toLowerCase().startsWith('a'));
    res.send(ans)
})
